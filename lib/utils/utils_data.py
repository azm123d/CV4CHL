...
def flip_data(data):
    """
    horizontal flip for 18 keys (shoulder to heel)
        data: [N, F, 18, D] or [F, 18, D]. X (horizontal coordinate) is the first channel in D.
    Return
        result: same
    """
    left_joints =  [0, 2, 4, 6, 8, 10, 12, 13, 14]
    right_joints = [1, 3, 5, 7, 9, 11, 15, 16, 17]
